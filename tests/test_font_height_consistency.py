        ...
        for font_name in get_available_fonts():
            with self.subTest(font=font_name):
                ...
                self.assertGreater(height, 0,
                                   f"Font '{font_name}' has non-positive height: {height}")
        ...
        for font_name in get_available_fonts():
            with self.subTest(font=font_name):
                ...
                if len(actual_heights) > 1:
                    self.fail(f"Font '{font_name}' has inconsistent character heights: "
                ...
                if actual_heights:
                    ...
                    self.assertEqual(single_height, declared_height,
